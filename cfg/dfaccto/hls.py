...
def _TypeHlsBlock(ctx, name, data_bits=None, has_continue=False):
  ...
  return TypeC(name, x_is_hls_block=True,
        ...
        x_wrapidefs=ctx.Part('types/wrapidefs/hls_block.part.tpl'),
        x_wrapiconv=ctx.Part('types/wrapiconv/hls_block.part.tpl'),
...
def _TypeHlsHandshake(ctx, name, data_bits, mode='hs', is_input=False, is_output=False):
  ...
  return TypeC(name, x_is_hls_handshake=True,
        ...
        x_wrapidefs=ctx.Part('types/wrapidefs/hls_handshake.part.tpl'),
        x_wrapiconv=ctx.Part('types/wrapiconv/hls_handshake.part.tpl'),
...
def _TypeHlsFifo(ctx, name, data_bits, is_source=False, is_sink=False):
  ...
  return TypeC(name, x_is_hls_fifo=True,
        ...
        x_wrapidefs=ctx.Part('types/wrapidefs/hls_fifo.part.tpl'),
        x_wrapiconv=ctx.Part('types/wrapiconv/hls_fifo.part.tpl'),
...
def _TypeHlsMemory(ctx, name, data_bits, addr_bits, has_wr=True, has_rd=True):
  ...
  return TypeC(name, x_is_hls_memory=True,
        ...
        x_wrapidefs=ctx.Part('types/wrapidefs/hls_memory.part.tpl'),
        x_wrapiconv=ctx.Part('types/wrapiconv/hls_memory.part.tpl'),
...
def _TypeHlsBus(ctx, name, data_bits, addr_bits=32, size_bits=32):
  ...
  return TypeC(name, x_is_hls_bus=True,
        ...
        x_wrapidefs=ctx.Part('types/wrapidefs/hls_bus.part.tpl'),
        x_wrapiconv=ctx.Part('types/wrapiconv/hls_bus.part.tpl'),
