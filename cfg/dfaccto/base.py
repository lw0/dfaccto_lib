...
with Pkg('dfaccto',
  ...
  TypeS('Logic',
        ...
        x_wrapidefs=Part('types/wrapidefs/logic.part.tpl'),
        x_wrapiconv=Part('types/wrapiconv/logic.part.tpl'),
  ...
  TypeS('Sys', x_is_sys=True,
        ...
        x_wrapidefs=Part('types/wrapidefs/sys.part.tpl'),
        x_wrapiconv=Part('types/wrapiconv/sys.part.tpl'),
