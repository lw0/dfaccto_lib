...
architecture CtrlRegDemux of CtrlRegDemux is
  ...
  function f_decode(v_absAddr : {{x_pm_regPorts.type.x_tRegAddr}}) return t_DecodedAddr is
    variable v_idx : t_PortNumber;
    variable v_portBegin : {{x_pm_regPorts.type.x_tRegAddr}};
    variable v_portCount : {{x_pm_regPorts.type.x_tRegAddr}};
    variable v_portAddr  : {{x_pm_regPorts.type.x_tRegAddr}};
    variable v_resPort   : t_PortNumber;
    variable v_resAddr   : {{x_pm_regPorts.type.x_tRegAddr}};
...
begin
  ...
  process (ai_sys.clk)
    ...
    variable v_relAddr : {{x_pm_regPorts.type.x_tRegAddr}};
  begin
