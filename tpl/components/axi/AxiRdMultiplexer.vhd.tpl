...
architecture AxiRdMultiplexer of {{identifier}} is
  ...
  type t_NativeAxiA_od is record
    addr    : {{x_pm_axiRd.type.x_taddr}};
    len     : {{x_pm_axiRd.type.x_tlen}};
    size    : {{x_pm_axiRd.type.x_tsize}};
    burst   : {{x_pm_axiRd.type.x_tburst}};
    lock    : {{x_pm_axiRd.type.x_tlock}};
    cache   : {{x_pm_axiRd.type.x_tcache}};
    prot    : {{x_pm_axiRd.type.x_tprot}};
    qos     : {{x_pm_axiRd.type.x_tqos}};
    region  : {{x_pm_axiRd.type.x_tregion}};
    id      : {{x_pm_axiRd.type.x_tid}};
    user    : {{x_pm_axiRd.type.x_taruser}};
    valid   : {{x_pm_axiRd.type.x_tlogic}};
  end record;
  type t_NativeAxiA_do is record
    ready   : {{x_pm_axiRd.type.x_tlogic}};
  end record;
